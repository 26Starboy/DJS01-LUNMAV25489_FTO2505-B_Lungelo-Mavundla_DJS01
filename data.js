const podcasts = [
  ...
  },
  {
    ...
    description: "What if your mother left to follow a cult… or you woke up in a morgue… or if your boat got caught in a storm and began to sink -- what would you do? This is Actually Happening brings you extraordinary true stories of life-changing events told by the people who lived them.",
    seasons: 12,
  ...
  },
  {
    ...
    description: "The Cold War, Prohibition, the Gold Rush, the Space Race. Every part of your life - the words you speak, the ideas you share - can be traced to our history, but how well do you really know the stories that made America?",
    seasons: 51,
  ...
  },
  {
    id: "10539",
    title: "Scamfluencers",
    description: "You never really know someone…especially online. In today's world, the power of influence can be the quickest path to money and fame, and it often ends in ruin.",
    seasons: 3,
  ...
  },
  {
    id: "9177",
    title: "Killer Psyche",
    description: "When a shocking crime occurs, people ask 'Why?' Was it about power, ego, or revenge? On Killer Psyche, retired FBI agent Candice DeLong draws on her decades of experience to reveal why these murderers and criminals committed these acts.",
    seasons: 2,
  ...
  },
  {
    id: "6807",
    title: "Even the Rich",
    description: "Our lives can be crazy, but you can take a break from it all with Wondery's new series, Even the Rich, where co-hosts Brooke Siffrinn and Aricia Skidmore-Williams pull back the curtain and chat about someone else's craziness for a change.",
    seasons: 33,
  ...
  },
  {
    ...
    description: "Humans are resilient. In our toughest moments, we will fight, we will struggle, and we will triumph...often against the odds.",
    seasons: 19,
  ...
  },
  {
    ...
    description: "This podcast might not actually kill you, but it covers so many things that can. Each episode tackles a different disease, from its history, to its biology, and finally, how scared you need to be.",
    seasons: 5,
